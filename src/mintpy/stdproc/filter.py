...
Examples:
  ...
  filter.py --processor isce3 --filter-type long_wavelength --input-dir ./unwrapped --pattern *.unw.tif --cor-dir ./correlation --cor-pattern *.phsig.coh.tif --wavelength-cutoff 50000 --correlation-cutoff 0.3
        """
    )
