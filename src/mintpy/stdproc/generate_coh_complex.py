...
Fixed output structure (see ``utils.naming``):
    ``output_dir/{date1}_{date2}/fullres.cpx.coh``      (isce2)
    ``output_dir/{date1}_{date2}/fullres.cpx.coh.tif``  (isce3)
...
def process_slc_pair(slc1_file: str, slc2_file: str, output_dir: Path,
    ...
    try:
        ...
        # Fixed structure: output_dir/{date1}_{date2}/fullres.cpx.coh[.tif]
